...
private:
	...
	void onHuongEditTextFieldClick(cocos2d::Ref * pSender, cocos2d::ui::TextField::EventType type);
...
class AboutPopUpLayer : public BaseLayer
{
public:

	static AboutPopUpLayer* createPopUpLayer(MainScene* i_mainScene);
